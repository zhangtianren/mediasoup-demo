...
const DirectionWay = require('./direction_way');
...
const TrackEncodingInfo = require('./track_encoding_info');
const SimulcastInfo = require('./simulcast_info');
const SimulcastStreamInfo = require('./simulcast_stream_info');
const RIDInfo = require('./rid_info');
...
class SDPInfo {
  ...
  toJSON() {
    ...
    sdp.msidSemantic = this.msidSemantic || {
      semantic: 'WMS',
      token: '*'
    };
    sdp.groups = [];
