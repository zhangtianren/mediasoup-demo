...
var ConnectionDescription = require(process.env.LICODE_NODE_PATH).ConnectionDescription;
var SdpInfo = require('./semantic_sdp/sdp_info');
var MediaInfo = require('./semantic_sdp/media_info');
var ICEInfo = require('./semantic_sdp/ice_info');
var DTLSInfo = require('./semantic_sdp/dtls_info');
var CodecInfo = require('./semantic_sdp/codec_info');
var SourceInfo = require('./semantic_sdp/source_info');
var StreamInfo = require('./semantic_sdp/stream_info');
var TrackInfo = require('./semantic_sdp/track_info');
var RIDInfo = require('./semantic_sdp/rid_info');
var CandidateInfo = require('./semantic_sdp/candidate_info');
var SimulcastInfo = require('./semantic_sdp/simulcast_info');
var Direction = require('./semantic_sdp/direction');
var DirectionWay = require('./semantic_sdp/direction_way');
var Setup = require('./semantic_sdp/setup');
...
class SessionDescription {
  ...
  processSdp() {
    ...
    sdp.medias.forEach((media, index) => {
      ...
      if (media.getType() === 'audio') {
        info.setAudioSdpMLine(index);
        audio = media;
      } else if (media.getType() === 'video') {
        info.setVideoSdpMLine(index);
        video = media;
      }
